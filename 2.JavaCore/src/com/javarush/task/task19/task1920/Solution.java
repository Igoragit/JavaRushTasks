...
public class Solution {
    public static void main(String[] args) throws IOException {
       ...
       //BufferedReader reader = new BufferedReader(new FileReader("G:/file.txt"));
        ...
        List<Map.Entry<String,Double>> entryList2 = new ArrayList<>(hashMap.entrySet());
        entryList2.sort(new Comparator<Map.Entry<String, Double>>() {
            @Override
            public int compare(Map.Entry<String, Double> o1, Map.Entry<String, Double> o2) {
        ...
        double old=entryList2.get(entryList2.size()-1).getValue();
