...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getFilledList() {
            ArrayList<PhantomReference<Monkey>> phantomReferences = new ArrayList<PhantomReference<Monkey>>();
            for ( int i = 0; i < 200; i++)
            {

                phantomReferences.add(new PhantomReference<Monkey>(new Monkey(), getQueue()));
            }
